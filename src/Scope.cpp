...
// {
// }
// ProgramScope::ProgramScope(std::map<std::string, Function> functions)
// {
//     this->global_functions = functions;
// }
...
// Function ProgramScope::get_global_function(std::string name)
// {
...
{
    if (global_functions.find(name) != this->global_functions.end())
    {
        return global_functions[name];
    }
    if (local_functions.find(name) != this->local_functions.end())
    {
